...
class FormKaryawanView
{
    ...
    public function renderUpdate($dataJabatan, $dataKaryawan)
    {
        // mengambil data jabatan untuk pilihan
        $dataOption = null;
        foreach ($dataJabatan as $temp) {
            if ($temp['jabatan_id'] == $dataKaryawan[0]['jabatan_id']) {
        ...
        $dataForm = null;
        $dataForm = '<label for="karyawan_nama">Nama:</label>
            <input type="hidden" name="id" value="' . $dataKaryawan[0]['karyawan_id'] . '" >
            <input type="text" id="karyawan_nama" name="karyawan_nama" value="' . $dataKaryawan[0]['karyawan_nama'] . '" required>
            ...
            <input type="date" id="karyawan_date" name="karyawan_date"  value="' . $dataKaryawan[0]['karyawan_date'] . '" required>

            <label for="karyawan_phone">Phone:</label>
            <input type="text" id="karyawan_phone" name="karyawan_phone"  value="' . $dataKaryawan[0]['karyawan_phone'] . '" required>
